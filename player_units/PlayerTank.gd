...
export var initial_health: int = 200
export var range_size: int = 150
export var gun_cooldown: float = 2
export var watch_group = "enemy_units"
export var initial_damage = 25
...
onready var sprite: Sprite = $SpriteManager/TankBase
...
func _on_Range_body_entered(body: KinematicBody2D):
	if body and body.is_in_group(watch_group):
